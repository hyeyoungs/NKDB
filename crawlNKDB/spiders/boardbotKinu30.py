...
###### 수정사항
class Boardbotkinu30Spider(scrapy.Spider):
    ###### 수정사항
    name = 'boardbotKinu30'
    allowed_domains = ['www.kinu.or.kr']
    ####### 수정사항
    start_urls = ['http://www.kinu.or.kr/brd/board/634/L/menu/371#']

    def __init__(self):
        scrapy.Spider.__init__(self)
        ####### 수정사항
        self.start_urls = 'http://www.kinu.or.kr/brd/board/634/L/menu/371#'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            ####### 수정사항
            link = "http://www.kinu.or.kr/brd/board/634/L/menu/371?brdType=L&searchField=&searchText=&thisPage=" + str(page_no)
            print(link)
