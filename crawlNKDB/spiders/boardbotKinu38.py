...
###### 수정사항
class Boardbotkinu38Spider(scrapy.Spider):
    ###### 수정사항
    name = 'boardbotKinu38'
    allowed_domains = ['www.kinu.or.kr']
    ####### 수정사항
    start_urls = ['http://www.kinu.or.kr/brd/board/726/L/menu/382']

    def __init__(self):
        scrapy.Spider.__init__(self)
        ####### 수정사항
        self.start_urls = 'http://www.kinu.or.kr/brd/board/726/L/menu/382'
