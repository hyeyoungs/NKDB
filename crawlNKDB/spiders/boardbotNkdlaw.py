...
# url 가져온다.
    def parse(self, response):
        ...
        while True:
            ...
            # print(link)
            yield scrapy.Request(link, callback = self.parse_each_pages, meta={'link': link,'page_no':page_no, 'last_page_no':last_page_no}, dont_filter = True)
            page_no += 1
