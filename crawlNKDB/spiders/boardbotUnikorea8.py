...
class Boardbotunikorea8Spider(scrapy.Spider):
    name = 'boardbotUnikorea8'
    #allowed_domains = ['unibook.unikorea.go.kr']
    start_urls = ['https://unibook.unikorea.go.kr/board/list?boardId=19']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://unibook.unikorea.go.kr/board/list?boardId=19'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://unibook.unikorea.go.kr/board/list?boardId=19&categoryId=&page="+str(page_no) + "&id=&field=searchAll&searchInput="
            #print(link)
    ...
    def parse_post(self, response):
        ...
        top_category = response.xpath('//*[@id="container"]/div/nav/ul/li[2]/ul/li[6]/a').xpath('string()').get()
        print(top_category)
