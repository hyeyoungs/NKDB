...
### modify
class Nuac4Spider(scrapy.Spider):
    ### modify
    name = 'nuac4'
    ### modify
    start_urls = ['http://www.nuac.go.kr/actions/BbsDataAction?cmd=list&menuid=G060519&bbs_id=G060519&_template=ebook&_max=5']

    def __init__(self):
        scrapy.Spider.__init__(self)
        ### modify
        self.start_urls = 'http://www.nuac.go.kr/actions/BbsDataAction?cmd=list&menuid=G060519&bbs_id=G060519&_template=ebook&_max=5'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            ### modify
            link = "http://www.nuac.go.kr/actions/BbsDataAction?cmd=list&menuid=G060519&bbs_num=&bbs_id=G060519&bbs_idx=&order=&ordertype=&oldmenu=&parent_idx=&_max=5&_page=" + str(page_no) + "&_template=ebook&searchtype=bbs_title&keyword=&name_confirm=&real_name="
            # print(link)
