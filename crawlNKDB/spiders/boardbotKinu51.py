...
###### 수정사항
class Boardbotkinu51Spider(scrapy.Spider):
    ###### 수정사항
    name = 'boardbotKinu51'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            ####### 수정사항
            link = "http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=335&category=36&thisPage=" + str(page_no) + "&searchField=&searchText="
            print(link)
