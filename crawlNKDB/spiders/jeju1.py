...
### modify
class Jeju1Spider(scrapy.Spider):
    ### modify
    name = 'jeju1'
    allowed_domains = ['www.jpi.or.kr']
    ### modify
    start_urls = ['http://www.jpi.or.kr/kor/issue/reports.sky?code=research']

    def __init__(self):
        scrapy.Spider.__init__(self)
        ### modify
        self.start_urls = 'http://www.jpi.or.kr/kor/issue/reports.sky?code=research'
    ...
    def parse(self, response):
        ...
        last_page_link = "http://www.jpi.or.kr/kor/issue/reports.sky?code=research&page=" + str(last_page_no) + "&"
        ...
        while True:
            if page_no > last_page_no:
                break
            ### modify
            link = "http://www.jpi.or.kr/kor/issue/reports.sky?code=research&page=" + str(page_no) + "&"
            #print(link)
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            ### modify
            item[config['VARS']['VAR7']] = response.xpath('//*[@id="left_menu"]/li[1]/a').xpath('string()').get()
