...
###### 수정사항
class Boardbotkinu52Spider(scrapy.Spider):
    ###### 수정사항
    name = 'boardbotKinu52'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            ####### 수정사항
            link = "http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=340&category=41&thisPage=" + str(page_no) + "&searchField=&searchText="
            print(link)
