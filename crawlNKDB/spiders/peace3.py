...
#######modify
class Peace3Spider(scrapy.Spider):
    #######modify
    name = 'peace3'
    #allowed_domains = ['www.pf.or.kr']
    #######modify
    start_urls = ['http://www.pf.or.kr/wpages/01-3_research_1.php?bbs_code=10001&bbs_cate=3']

    def __init__(self):
        scrapy.Spider.__init__(self)
        #######modify
        self.start_urls = 'http://www.pf.or.kr/wpages/01-3_research_1.php?bbs_code=10001&bbs_cate=3'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            #######modify
            link = "http://www.pf.or.kr/wpages/01-3_research_1.php?bbs_code=10001&bbs_cate=3&sypage=&page="+ str(page_no) +"&keyword=&search="
            #print(link)
    ...
    def parse_post(self, response):
        ...
        #######modify
        top_category = response.xpath('//*[@id="rep_tab_btn04"]/a').xpath('string()').get()
