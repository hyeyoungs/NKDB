...
###### 수정사항
class Boardbotkinu31Spider(scrapy.Spider):
    ###### 수정사항
    name = 'boardbotKinu31'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            ####### 수정사항
            link = "http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=351&category=53&thisPage=" + str(page_no) + "&searchField=title&searchText="
            print(link)
