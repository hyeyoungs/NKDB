...
class Boardbotkoreahana1Spider(scrapy.Spider):
    name = 'boardbotKoreahana1'
    allowed_domains = ['www.koreahana.or.kr']
    start_urls = ['https://www.koreahana.or.kr/data_room/pro_data.jsp?sc_board_seq=60&sc_category_text=%EC%8B%A4%ED%83%9C%EC%A1%B0%EC%82%AC&sc_searchCnd=title&page=1']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://www.koreahana.or.kr/data_room/pro_data.jsp?sc_board_seq=60&sc_category_text=%EC%8B%A4%ED%83%9C%EC%A1%B0%EC%82%AC&sc_searchCnd=title&page=1'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://www.koreahana.or.kr/data_room/pro_data.jsp?sc_board_seq=60&sc_category_text=%EC%8B%A4%ED%83%9C%EC%A1%B0%EC%82%AC&sc_searchCnd=title&page="+str(page_no)
            #print(link)
