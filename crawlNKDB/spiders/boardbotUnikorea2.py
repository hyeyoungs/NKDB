...
class Boardbotunikorea2Spider(scrapy.Spider):
    name = 'boardbotUnikorea2'
    #allowed_domains = ['unibook.unikorea.go.kr']
    start_urls = ['https://unibook.unikorea.go.kr/board/list?boardId=20']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://unibook.unikorea.go.kr/board/list?boardId=20'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://unibook.unikorea.go.kr/board/list?boardId=20&categoryId=&page="+str(page_no) + "&id=&field=searchAll&searchInput="
            #print(link)
