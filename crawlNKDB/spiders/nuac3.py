...
### modify
class Nuac3Spider(scrapy.Spider):
    ### modify
    name = 'nuac3'
    ### modify
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            body = " "
            writer = "관리자"
            date = response.xpath('//*[@id="main"]/div/div[2]/div/div[4]/table[2]/tbody/tr['+str(category_no)+']/td[5]/div/font').xpath('string()').get()
            top_category = response.xpath('//*[@id="main"]/div/div[1]/div[2]/a').xpath('string()').get()
            ...
            ### modify
            file_name = title
            file_download_url = response.xpath('//*[@id="main"]/div/div[2]/div/div[4]/table[2]/tbody/tr['+str(category_no)+']/td[4]/div/a/@href').get()
            category_no += 1
