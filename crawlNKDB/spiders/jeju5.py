...
### modify
class Jeju5Spider(scrapy.Spider):
    ### modify
    name = 'jeju5'
    allowed_domains = ['www.jpi.or.kr']
    ### modify
    start_urls = ['http://www.jpi.or.kr/kor/regular/policy.sky?code=assay']

    def __init__(self):
        scrapy.Spider.__init__(self)
        ### modify
        self.start_urls = 'http://www.jpi.or.kr/kor/regular/policy.sky?code=assay'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            ### modify
            link = "http://www.jpi.or.kr/kor/regular/policy.sky?code=assay&page=" + str(page_no) + "&"
            #print(link)
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            print(title)
            writer = response.xpath('//*[@id="sub_reports"]/ul['+ str(category_no) +']/li[2]').xpath('string()').get()
