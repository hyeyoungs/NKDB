...
class Boardbotkinu1Spider(scrapy.Spider):
    name = 'boardbotKinu1'
    allowed_domains = ['www.kinu.or.kr']
    start_urls = ['http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=256&category=4&thisPage=1&searchField=&searchText=']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=256&category=4&thisPage=1&searchField=&searchText='
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=256&category=4&thisPage=" + str(page_no) + "&searchField=title&searchText="
            print(link)
