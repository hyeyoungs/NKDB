...
class Boardbotkoreahana5Spider(scrapy.Spider):
    ...
    start_urls = ['https://www.koreahana.or.kr/data_room/pro_data.jsp?sc_board_seq=60&sc_category_text=%EC%97%B0%EA%B5%AC%EC%B4%9D%EC%84%9C&sc_searchCnd=title&page=1']

    def __init__(self):
        scrapy.Spider.__init__(self)
        self.start_urls = 'https://www.koreahana.or.kr/data_room/pro_data.jsp?sc_board_seq=60&sc_category_text=%EC%97%B0%EA%B5%AC%EC%B4%9D%EC%84%9C&sc_searchCnd=title&page=1'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            link = "https://www.koreahana.or.kr/data_room/pro_data.jsp?sc_board_seq=60&sc_category_text=%EC%97%B0%EA%B5%AC%EC%B4%9D%EC%84%9C&sc_searchCnd=title&page="+str(page_no)
            #print(link)
