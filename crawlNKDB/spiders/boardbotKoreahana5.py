...
class Boardbotkoreahana5Spider(scrapy.Spider):
    name = 'boardbotKoreahana5'
    allowed_domains = ['www.koreahana.or.kr']
    ### modify
    start_urls = ['https://www.koreahana.or.kr/data_room/pro_data.jsp?sc_board_seq=60&sc_category_text=%EC%84%9D%EC%82%AC%EB%85%BC%EB%AC%B8&sc_searchCnd=title&page=1']

    def __init__(self):
        scrapy.Spider.__init__(self)
        ### modify
        self.start_urls = 'https://www.koreahana.or.kr/data_room/pro_data.jsp?sc_board_seq=60&sc_category_text=%EC%84%9D%EC%82%AC%EB%85%BC%EB%AC%B8&sc_searchCnd=title&page=1'
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            ### modify
            link = "https://www.koreahana.or.kr/data_room/pro_data.jsp?sc_board_seq=60&sc_category_text=%EC%84%9D%EC%82%AC%EB%85%BC%EB%AC%B8&sc_searchCnd=title&page="+str(page_no)
            #print(link)
    ...
    def parse_each_pages(self, response):
        ...
        while True:
            ...
            ### modify
            top_category = response.xpath('//*[@id="container"]/div[1]/div[2]/div[2]/div/div[2]/ul/li[4]/a').xpath('string()').get()
