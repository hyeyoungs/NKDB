...
###### 수정사항
class Boardbotkinu35Spider(scrapy.Spider):
    ###### 수정사항
    name = 'boardbotKinu35'
    allowed_domains = ['www.kinu.or.kr']
    ####### 수정사항
    start_urls = ['http://www.kinu.or.kr/www/jsp/prg/api/dlL2.jsp?menuIdx=356&category=128&thisPage=1&searchField=&searchText=']

    def __init__(self):
        scrapy.Spider.__init__(self)
        ####### 수정사항
        self.start_urls = 'http://www.kinu.or.kr/www/jsp/prg/api/dlL2.jsp?menuIdx=356&category=128&thisPage=1&searchField=&searchText='
