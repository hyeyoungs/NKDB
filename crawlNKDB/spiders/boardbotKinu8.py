...
###### 수정사항
class Boardbotkinu8Spider(scrapy.Spider):
    ###### 수정사항
    name = 'boardbotKinu8'
    allowed_domains = ['www.kinu.or.kr']
    ####### 수정사항
    start_urls = ['http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=263&category=12&thisPage=1&searchField=&searchText=']

    def __init__(self):
        scrapy.Spider.__init__(self)
        ####### 수정사항
        self.start_urls = 'http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=263&category=12&thisPage=1&searchField=&searchText='
    ...
    def parse(self, response):
        ...
        while True:
            if page_no > last_page_no:
                break
            ####### 수정사항
            link = "http://www.kinu.or.kr/www/jsp/prg/api/dlL.jsp?menuIdx=263&category=12&thisPage=" + str(page_no) + "&searchField=title&searchText="
            print(link)
